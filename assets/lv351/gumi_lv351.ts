...
import ArrowNote351 from "./ArrowNote351";

const { ccclass, property } = cc._decorator;

@ccclass
export default class gumi_lv341 extends BaseGame {
    canjiaohu = false;
    flag = true;
    ...
    @property(ArrowNote351)
    arrowCtrl: ArrowNote351 = null;
    ...
    onLoad() {
        ...
        // 开始游戏
        this.scheduleOnce(() => {
            AudioManager.playMusic(`bgmlv351`, true, 0.5);
