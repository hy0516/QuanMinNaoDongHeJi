...
import jmtx_lv364 from "./jmtx_lv364";

const {ccclass, property} = cc._decorator;

@ccclass
export default class moveitem_lv364 extends cc.Component {
    ...
    protected onLoad(): void {
        ...
        this.mainScript = this.main.getComponent("jmtx_lv364");
