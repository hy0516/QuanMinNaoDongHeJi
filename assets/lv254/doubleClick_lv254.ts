...
@ccclass
export default class doubleClick_lv254 extends cc.Component {
    @property(cc.Integer)
    ...
    EventHandle(){
        switch(Number(this.type)){
            //抽屉
            case 1 :
                this.MainNode.getComponent(zjmgr_lv254).openDesk();
                break;
            //窗户
            case 2 :
                this.MainNode.getComponent(zjmgr_lv254).openWindow();
                break;
        }
    }
