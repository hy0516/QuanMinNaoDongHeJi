...
export default class KsHttpUpBehavior {
    ...
    private ksIsExist(cb?: Function) {
        ...
        this.functionPost(is_exist_url, { app_id: AdsOptions.ks.ks_app_id }, (data) => {
            if (data.code == 1) {
    ...
    public userActive() {
        ...
        if (KsHttpUpBehavior.ks_is_exist == 1) {
            ...
            if (localStorage.getItem("bury_user_active") != "1") {
                ...
                let param = { user_code: code, callback: KsHttpUpBehavior.ks_callback, app_id: AdsOptions.ks.ks_app_id, campaign_id: campaignId, unit_id: unitId, account_id: accountId };
                ...
                if (KsHttpUpBehavior.ks_callback != undefined && KsHttpUpBehavior.ks_callback != null && KsHttpUpBehavior.ks_callback.length > 10) {
                    ...
                    if (localStorage.getItem("ks_game_active") != "1") {
                        let param = { open_id: KsHttpUpBehavior.ks_open_id, callback: KsHttpUpBehavior.ks_callback, app_id: AdsOptions.ks.ks_app_id, campaign_id: campaignId, unit_id: unitId, account_id: accountId };
    ...
    public videoUpdate() {
        ...
        if (KsHttpUpBehavior.ks_callback != undefined && KsHttpUpBehavior.ks_callback != null && KsHttpUpBehavior.ks_callback.length > 10) {
            ...
            temp_num = temp_num + 1;
            let param = { open_id: KsHttpUpBehavior.ks_open_id, video_num: temp_num, app_id: AdsOptions.ks.ks_app_id };
    ...
    public eventInfo(event: string, state: string, describe: string = '') {
        ...
        if (KsHttpUpBehavior.ks_open_id && KsHttpUpBehavior.ks_is_exist == 1) {
            let param = { open_id: KsHttpUpBehavior.ks_open_id, app_id: AdsOptions.ks.ks_app_id, action: event, state: state, describe: describe };
