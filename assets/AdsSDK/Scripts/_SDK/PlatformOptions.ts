...
/** 平台广告相关参数 */
const AdsOptions = {
    _PKG_str: "com.sqdz.ks", // 包名
    _CP: "KS1", // 开关号
    target_time: "2026-02-06T21:00:00", // 快手插屏屏蔽时间终点
    // 快手
    ks: {
        ks_app_id: "ks650207197512702042",
        videoId: "2300051905_01",
        insertId: "2300051905_02",
...
export default class Apis {
    ...
    /** SDK存储的数据 */
    private sdkTempData: { [key: string]: any; } = {}
    /** 记录桌面奖励领取次数 */
    ...
    /** 保存SDK数据(不持久化) */
    public setSdkTempData(key: string, value: any) {
        this.sdkTempData[key] = value;
    }
    /** 获取SDK数据 */
    ...
    /** 保存SDK数据(不持久化) */
    public getSdkTempData(key: string) {
        return this.sdkTempData[key] || null
    }
    ...
    public showTips(
        ...
        switch (AdsOptions.platform) {
            case LPPlatform.toutiao:
                ...
                window[AdsOptions.platform].showToast(ToastBody);
                break;
            case LPPlatform.zfb:
