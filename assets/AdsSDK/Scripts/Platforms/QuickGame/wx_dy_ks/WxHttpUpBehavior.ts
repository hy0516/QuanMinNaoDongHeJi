...
export default class WxHttpUpBehavior {
    ...
    public activUser() {
        ...
        param = param + "&click_id=" + WxHttpUpBehavior.wx_dy_click_id + "&chan_type=" + chan_type + "&app_id=" + SDK_config.GameIdConfig.weixinID.appId;
    ...
    public jsCodeSession() {
        ...
        if (code && code != undefined && code != "undefined" && code != null && code != "null" && code != "") {
            let param = "code=" + code + "&app_id=" + SDK_config.GameIdConfig.weixinID.appId;
    ...
    public lastUserTime() {
        if (!SDK_config.openMaiLiang) return;
        let param = "open_id=" + WxHttpUpBehavior.wx_open_id + "&app_id=" + SDK_config.GameIdConfig.weixinID.appId;
    ...
    public ecpm(encryptedData: string, iv: string) {
        ...
        //     return;
        // }
        let param = "open_id=" + WxHttpUpBehavior.wx_open_id + "&encryptedData=" + encryptedData + "&iv=" + iv + "&app_id=" + SDK_config.GameIdConfig.weixinID.appId;
