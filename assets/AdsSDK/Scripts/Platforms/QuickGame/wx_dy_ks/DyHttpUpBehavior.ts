...
export default class DyHttpUpBehavior {
    ...
    public lastUserTime() {
        ...
        var self = this;
        let param = "open_id=" + DyHttpUpBehavior.dy_open_id + "&app_id=" + SDK_config.GameIdConfig.toutiaoID.appId;
    ...
    private userActiveLst(code: string, isLogin: Boolean) {
        ...
        if (localStorage.getItem("dy_game_active") != "1") {
            ...
            let param = "open_id=" + code + "&click_id=" + DyHttpUpBehavior.dy_click_id + "&app_id=" + SDK_config.GameIdConfig.toutiaoID.appId + "&promotion_id=" + promotionid;
    ...
    public videoUpdate() {
        ...
        if (DyHttpUpBehavior.dy_click_id) {//判断是否有点击ID 如果没有就不上报给后端
            ...
            let param = "open_id=" + DyHttpUpBehavior.dy_open_id + "&click_id=" + DyHttpUpBehavior.dy_click_id + "&video_num=" + temp_num + "&app_id=" + SDK_config.GameIdConfig.toutiaoID.appId;
        ...
        if (timeDate) {
            ...
            if (this.convertToDate(todays) > this.convertToDate(timeDate)) {
                ...
                if (DyHttpUpBehavior.dy_click_id) {//当前用户为广告用户时
                    ...
                    let param = "open_id=" + DyHttpUpBehavior.dy_open_id + "&app_id=" + SDK_config.GameIdConfig.toutiaoID.appId + "&click_id=queryEcpm";
