...
@ccclass
export default class UI_oppoNativeBanner extends cc.Component {
    ...
    onEnable(){
        ...
        this.flushbanner=setInterval(function(){
           self.counttime++
            if (self.counttime==SDK_config.GameIdConfig.oppoID.bannerFlushTime) {
                self.counttime=0;
                sbanner();
            }
        },1000);
