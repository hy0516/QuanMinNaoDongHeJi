...
@ccclass
export default class UI_oppoNativeAd extends UISDKWindow {
    ...
    onEnable(){
        ...
        self.bg_click.on(cc.Node.EventType.TOUCH_START, self.onClickAd, self);
    ...
    onDisable(){
        ...
        let self = this;
        self.bg_click.off(cc.Node.EventType.TOUCH_START, self.onClickAd, self);
    ...
    initLayer(res) {
        ...
        try {
            ...
            console.log('==self.node.scale====='+self.node.scale);
