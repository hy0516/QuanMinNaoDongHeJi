...
import shj_lv381 from "./xhwd_lv381";


const { ccclass, property } = cc._decorator;
@ccclass
export default class itme_move_lv381 extends cc.Component {
   ...
   startIndex = 0;
    ...
    Inof(mian:cc.Node){
        ...
        this.mainNode = mian;
        this.levelComp = this.mainNode.getComponent(shj_lv381);
    ...
    onTouchStart(event?: cc.Event.EventTouch) {
        ...
        this.levelComp && this.levelComp.startTimer();
    ...
    putInof(event: cc.Event.EventTouch): { valid: boolean; targetAreaIndex?: number; swapRole?: itme_move_lv381 } {
    ...
    /** 查找占据某区域的另一角色（排除自己） */
    findRoleInArea(aera: cc.Node): itme_move_lv381 | null {
