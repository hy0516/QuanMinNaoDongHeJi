...
import HCSHJ_EventType_299 from "./HCSHJ_EventType_299";
...
@ccclass
export default class hcshj_lv299 extends BaseGame {
    @property(cc.Node)
...
private processingPairs: Set<string> = new Set();
    onLoad() {
        ...
        this.scheduleOnce(()=>{
            AudioManager.playMusic(`关卡背景_299`,null,0.9);
        },0.5)
      ...
      //   cc.director.getCollisionManager().enabledDebugDraw = true;
        ...
        this.node.on(HCSHJ_EventType_299.CONTACTCOLLIDER_EVENT,this.onContactBegin,this)
        this.node.on(HCSHJ_EventType_299.GAMELOST_EVENT,this.onlost,this)
   ...
   //         console.log("Move:",this.movex);
    ...
    private mergeNodes(nodeA: cc.Node, nodeB: cc.Node,nocenterPos?:boolean) {
        ...
        let nextLv = Number(nodeA.name.split("lv")[1]) + 1;

       // console.log(nextLv);
     
        AudioManager.playEffect(`合成_299`);//播放合成声音
        AudioManager.playEffect('lv'+nextLv.toString()+`_299`);
