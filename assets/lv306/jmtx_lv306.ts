...
import gameData_lv306 from "./gameData_lv306";

const {ccclass, property} = cc._decorator;

@ccclass
export default class jmtx_lv306 extends BaseGame {
    ...
    protected onLoad(): void {
        ...
        AudioManager.playMusic("关卡背景lv306", false, 0.5);

        this.time.string = "时间:" + this.startTime.toString() + "s";
        this.schedule(this.Timeing, 1);

        this.gameData = this.node.getComponent(gameData_lv306);
        this.curLv = 1;
    ...
    upAndDownPage(isRight: boolean) {
        ...
        if (this.pageView.getCurrentPageIndex() + uppage == 5){
    ...
    nextLv(){
        ...
        if (this.lvNum[this.curLv - 1] == this.gameData.gameConfig[this.curLv][0].value) {
            ...
            else if (this.curLv == 6 && this.winValue < 5) {
                this.curLv = 1;
                this.pageView.scrollToPage(0, 0);
                this.getSlotName();
            }
