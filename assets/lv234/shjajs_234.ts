...
@ccclass
export default class shjajs_234 extends BaseGame {
    @property(cc.Label)
    time: cc.Label = null;
    @property(cc.Node)
    ...
    onLoad() {
        ...
        this.scheduleOnce(() => {
            AudioManager.playMusic("关卡背景234");
        }, 0.5)
        ...
        //     )
        //     .start()
        this.node.on(evenMap_234.CheckWuTai, this.checkWuTai, this);
    }
    checkWuTai() {
        ...
        switch (event.currentTarget.name) {
            ...
            case "next":
                ...
                for (let i = 0; i < wutai.childrenCount; i++) {
                    ...
                    chil.emit(evenMap_234.TouchCancel);
                }
                this.step++;
