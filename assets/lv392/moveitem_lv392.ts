import dwbe_lv392 from "./dwbe_lv392";

const {ccclass, property} = cc._decorator;

@ccclass
export default class moveitem_lv392 extends cc.Component {
    ...
    protected onLoad(): void {
        ...
        this.mainSrict = this.main.getComponent("dwbe_lv392");
    }
    ...
    //移动节点动画
    MoveNode(){
        this.mainSrict.stopScene1BtnBreath();
        //本节点移动
        cc.tween(this.node)
