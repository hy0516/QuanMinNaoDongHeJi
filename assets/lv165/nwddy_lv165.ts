...
import item_lv165 from "./item_lv165";

const { ccclass, property } = cc._decorator;

@ccclass
export default class nwddy_lv165 extends BaseGame {
    @property(cc.Node)
    lvtext: cc.Node = null;
    @property(cc.Node)
    ...
    onLoad() {
        ...
        this.scheduleOnce(() => { AudioManager.playMusic("关卡背景_lv165"); }, 0.5)
    ...
    initlv() {
        ...
        for (let i = 0; i < this.nodeNumList[this.curlv - 1]; i++) {
            ...
            item.parent = lvnode;
            item.getComponent(item_lv165).initmain(this, i);
    ...
    xitongseleDuyao() {
        ...
        if (lvnode.children[num].getComponent(item_lv165).isduyao == true) {
            this.xitongseleDuyao();
        } else {
            lvnode.children[num].getComponent(item_lv165).isduyao = true;
    ...
    seleItem(item: cc.Node) {
        ...
        cc.tween(this.renshou)
            ...
            .call(() => {
                ...
                item.getChildByName(item.getComponent(item_lv165).curindex.toString()).active = false;
            })
    ...
    robotSeleItem() {
        ...
        cc.tween(this.robotshou)
            ...
            .call(() => {
                ...
                robotseleitem.getComponent(item_lv165).onSeleHandler();
    ...
    showTip() {
        ...
        VideoManager.getInstance().showVideo(() => {
            ...
            this.robotSeleDuyao.getChildByName(this.robotSeleDuyao.getComponent(item_lv165).curindex.toString()).children[0].active = true;
        })
    }
