...
import ArrowNote354 from "./ArrowNote354";

const { ccclass, property } = cc._decorator;

@ccclass
export default class gumi_lv354 extends BaseGame {
    canjiaohu = false;
    flag = true;
    ...
    @property(ArrowNote354)
    arrowCtrl: ArrowNote354 = null;
    ...
    onLoad() {
        ...
        const sheet = [
            // 第1行: ← ← ← ← (左左右右) - interval 0.8  左3 右1 上4 下2
            ...
            // 空5秒
            { interval: 5.0, lanes: [] },
            // 第2行: → → → → (下下下下) - interval 0.8
            { interval: 0.0, lanes: [4] },
            { interval: 0.8, lanes: [4] },
            { interval: 0.8, lanes: [2] },
            { interval: 0.8, lanes: [2] },
            // 空5秒
            { interval: 5.0, lanes: [] },
        ...
        // 开始游戏
        this.scheduleOnce(() => {
            AudioManager.playMusic(`bgmlv354`, true, 0.5);
