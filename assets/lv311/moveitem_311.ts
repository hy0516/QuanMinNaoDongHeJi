...
@ccclass
export default class moveitem_311 extends cc.Component {
    ...
    onTouchStart(even: cc.Event.EventTouch) {
        ...
        this.wupinglan.getComponent(`moving_311`).moving = true;
    ...
    onTouchEnd(even: cc.Event.EventTouch) {
        ...
        this.wupinglan.getComponent(`moving_311`).moving = false;
