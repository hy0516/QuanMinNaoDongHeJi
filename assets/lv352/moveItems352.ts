...
@ccclass
export default class moveItems352 extends cc.Component {
    ...
    protected onLoad(): void {
        ...
        this.musicqs = this.main.getComponent(`ntcb_lv352`).musicqs;
    }
    ...
    onTouchStart(even: cc.Event.EventTouch) {
        ...
        this.main.getComponent(`ntcb_lv352`).changeeyes();
    }
    ...
    onTouchMove(even: cc.Event.EventTouch) {
        ...
        this.main.getComponent(`ntcb_lv352`).eyeslookat(this.node.convertToWorldSpaceAR(cc.Vec2.ZERO));
    ...
    onTouchEnd(even: cc.Event.EventTouch) {
        ...
        this.main.getComponent(`ntcb_lv352`).eyesstop();
        if (this.main) this.main.getComponent(BaseGame).moveHandler(this.type, null, even);
        console.log("触摸结束，是否摇晃：" + this.isShaked);
        if (this.type === 2) {
            this.main.getComponent(`ntcb_lv352`).musicqs.getComponent(cc.AudioSource).mute = true;
        }
    }
