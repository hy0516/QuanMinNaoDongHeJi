...
@ccclass    /** 羊 */
export default class Sheep_CorrallingFlock309 extends cc.Component {
    ...
    onBeginContact(contact: cc.PhysicsContact, selfCollider: cc.PhysicsCollider, otherCollider: cc.PhysicsCollider) {
        if (otherCollider.node.name == "wolf"||otherCollider.node.name == "tyzr") {
            ...
            this.setRedColor();
            //直接游戏失败
            this.node.dispatchEvent(new cc.Event.EventCustom(DX_EventType309.CrossTheRiver_OnGameFail, true));
        }
