...
@ccclass
export default class moveitem_339 extends cc.Component {
    ...
    onTouchStart(even: cc.Event.EventTouch) {
        if (this.node.getChildByName("视频图标") && !this.isgd) {
            VideoManager.getInstance().showVideo(() => {
                this.isgd = true;
                this.node.getChildByName("视频图标").active = false;
            });
        }
        ...
        // if (this.mainNode.getComponent("shjajs_339").isMask) {
        //     return;
        // }
