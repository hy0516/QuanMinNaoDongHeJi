...
@ccclass
export default class RouteLogic_CorrallingFlock296 extends cc.Component {
    ...
    createRigibody() {
        ...
        let cusEvent = new cc.Event.EventCustom(DX_EventType2.CorrallingFlock_OnDrawFinish, true);
