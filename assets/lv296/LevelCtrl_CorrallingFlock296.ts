import Sheep_CorrallingFlock296 from "./Sheep_CorrallingFlock296";
import Wolf_CorrallingFlock296 from "./Wolf_CorrallingFlock296";

import Shepherd_CorrallingFlock296 from "./Shepherd_CorrallingFlock296";
import GameViewLogic_CorallingFlock296 from "./GameViewLogic_CorrallingFlock296";
import AnswerLogic_CorrallingFlock296 from "./AnswerLogic_CorrallingFlock296";
import CircleNode_CorrallingFlock2 from "./CircleNode_CorrallingFlock296";
import DX_Config2 from "./DX_Config296";
import DX_EventType2 from "./DX_EventType296";
import GameData from "../script/common/GameData";
import AudioManager from "../script/common/AudioManager";
import BaseGame from "../script/common/BaseGame";
import VideoManager from "../script/common/VideoManager";
import RouteLogic_CorrallingFlock296 from "./RouteLogic_CorrallingFlock296";
...
export default class LevelCtrl_CorrallingFlock2  extends BaseGame {
    ...
    private gameViewLogic: GameViewLogic_CorallingFlock296 = null;
    private sheepArr: Sheep_CorrallingFlock296[] = null;
    private wolfArr: Wolf_CorrallingFlock296[] = null;
    ...
    onLoad() {
        ...
        AudioManager.playMusic(music.关卡背景lv296, true, 0.8);

        
        this.map = this.node.getChildByName("map");
        this.shepherd = this.map.getComponentInChildren(Shepherd_CorrallingFlock296).node;
        ...
        this.gameViewLogic = this.map.getChildByName("GameViewLogic").getComponent(GameViewLogic_CorallingFlock296);
        this.sheepArr = this.map.getComponentsInChildren(Sheep_CorrallingFlock296);
        this.wolfArr = this.map.getComponentsInChildren(Wolf_CorrallingFlock296);
    ...
    start() {
        ...
        if(this.gameViewLogic.getComponentInChildren(AnswerLogic_CorrallingFlock296)){
            this.gameViewLogic.getComponentInChildren(AnswerLogic_CorrallingFlock296).onDrawAnswer(DX_Config2.CorrallingFlock_Guide);
        }
    }
    onDestroy() {
    ...
    onDrawFinish(event: cc.Event.EventCustom) {
        ...
        if(this.gameViewLogic.getComponentInChildren(AnswerLogic_CorrallingFlock296)){
            this.gameViewLogic.getComponentInChildren(AnswerLogic_CorrallingFlock296).node.destroy();
        }
    }
