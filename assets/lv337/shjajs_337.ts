...
import lianxian_224 from "../lv225/lianxian_225";
...
@ccclass
export default class shjajs_337 extends BaseGame {
    @property(cc.Label)
    time: cc.Label = null;
    @property(cc.Node)
    ...
    onLoad() {
        ...
        this.scheduleOnce(() => {
            AudioManager.playMusic("关卡背景lv337", false, 0.5);
        }, 0.5)
