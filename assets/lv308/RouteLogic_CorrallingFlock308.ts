...
@ccclass
export default class RouteLogic_CorrallingFlock308 extends cc.Component {
    ...
    createRigibody() {
        ...
        let cusEvent = new cc.Event.EventCustom(DX_EventType308.CorrallingFlock_OnDrawFinish, true);
