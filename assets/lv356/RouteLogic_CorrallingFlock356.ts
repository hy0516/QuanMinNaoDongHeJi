...
@ccclass
export default class RouteLogic_CorrallingFlock356 extends cc.Component {
    ...
    createRigibody() {
        ...
        let cusEvent = new cc.Event.EventCustom(DX_EventType356.CorrallingFlock_OnDrawFinish, true);
