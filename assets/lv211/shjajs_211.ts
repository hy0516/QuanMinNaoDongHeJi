...
@ccclass
export default class shjajs_211 extends BaseGame {
    @property(cc.Label)
    time: cc.Label = null;
    @property(cc.Node)
    ...
    onLoad() {
        ...
        this.scheduleOnce(() => {
            AudioManager.playMusic("关卡背景211");
        }, 0.5)
        ...
        //     )
        //     .start()
        this.node.on(evenMap_211.CheckWuTai, this.checkWuTai, this);
    }
    checkWuTai() {
        ...
        switch (event.currentTarget.name) {
            ...
            case "next":
                ...
                for (let i = 0; i < wutai.childrenCount; i++) {
                    ...
                    chil.emit(evenMap_211.TouchCancel);
                }
                this.step++;
