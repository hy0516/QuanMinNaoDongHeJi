...
import HCSHJ_EventType_251 from "./HCSHJ_EventType_251";
...
@ccclass
export default class hcshj_lv251 extends BaseGame {
    @property(cc.Node)
...
private processingPairs: Set<string> = new Set();
    onLoad() {
        ...
        this.scheduleOnce(()=>{
            AudioManager.playMusic(`背景音乐_251`,null,0.9);
        },0.5)
        ...
        this.node.on(HCSHJ_EventType_251.CONTACTCOLLIDER_EVENT,this.onContactBegin,this)
        this.node.on(HCSHJ_EventType_251.GAMELOST_EVENT,this.onlost,this)
   ...
   //         console.log("Move:",this.movex);
    ...
    private mergeNodes(nodeA: cc.Node, nodeB: cc.Node,nocenterPos?:boolean) {
       ...
       // console.log(nextLv);
        ...
        AudioManager.playEffect(`合成_251`);//播放合成声音
        AudioManager.playEffect('lv'+nextLv.toString()+`_251`);
