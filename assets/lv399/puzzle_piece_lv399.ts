...
@ccclass
export default class PuzzlePiece399 extends cc.Component {
     ...
     * （由 pt_lv399 的 debugShowPieceIndex 控制，上线前关掉）
     */
    ...
    /**
     * @param roundTL…roundBL 是否为连通块外轮廓凸角（圆角），与 pt_lv399 蒙版一致
     */
    refreshBorders(
        showL: boolean,
        showR: boolean,
        ...
        const w = x1 - x0;
        const h = y1 - y0;
        // 与 pt_lv399 圆角蒙版同一外轮廓（同 rr），描边中心线贴可见图边界；线宽一半在格内一半在格外，未拼合时可能略压缝
