...
export default class moveItem_lv254 extends cc.Component {
    ...
    onTouchEnd(even: cc.Event.EventTouch) {
        ...
        if (this.main) this.main.getComponent(zjmgr_lv262).itmeMoveHandler(this.type,even);
    ...
    handle(){
        ...
        //console.log(this.main.getComponent(zjmgr_lv262).lvNum );
        //体检报告
        if(this.type == 10 && this.main.getComponent(zjmgr_lv262).lvNum < 6){
            return false;
        }
