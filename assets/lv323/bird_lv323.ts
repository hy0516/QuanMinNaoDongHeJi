...
@ccclass
export default class BirdLv323 extends cc.Component {
    ...
    onLoad() {
        ...
        this.peckComp = this.colliderNd.getComponent(`peck_lv323`);
        this.main = this.mainNd.getComponent(`zmn_lv323`);
        this.father = this.node.parent.getComponent(`ball_lv323`);
    ...
    onTouch(event: cc.Event.EventTouch) {
        ...
        this.scheduleOnce(() => {
            ...
            if (!this.peckComp.checkdead()) {
                this.armature.playAnimation(`tiao1`, 1);
                this.scheduleOnce(this.resetIdle, 0.3);
                ...
                this.armature.playAnimation(`tiao2`, 1);
                this.speed = 0;
                this.scheduleOnce(() => {
                    this.main.notpass();
                }, 1);
    ...
    private resetIdle = () => {
        this.resetSpeed();
        this.armature.playAnimation(`dun`, 0);
    };
