...
import ArrowNote_lv395 from "./ArrowNote_lv395";

const { ccclass, property } = cc._decorator;

@ccclass
export default class gumi_lv395 extends BaseGame {
    canjiaohu = false;
    flag = true;
    ...
    @property(ArrowNote_lv395)
    arrowCtrl: ArrowNote_lv395 = null;
    ...
    onLoad() {
        ...
        // 开始游戏
        this.scheduleOnce(() => {
            AudioManager.playMusic(`bgmlv395`, true, 0.5);
            if (this.arrowCtrl) {
