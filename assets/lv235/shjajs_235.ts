...
@ccclass
export default class shjajs_235 extends BaseGame {
    @property(cc.Label)
    time: cc.Label = null;
    @property(cc.Node)
    ...
    onLoad() {
        ...
        this.scheduleOnce(() => {
            AudioManager.playMusic("关卡背景235");
        }, 0.5)
        ...
        //     )
        //     .start()
        this.node.on(evenMap_235.CheckWuTai, this.checkWuTai, this);
    }
    checkWuTai() {
        ...
        switch (event.currentTarget.name) {
            ...
            case "next":
                ...
                for (let i = 0; i < wutai.childrenCount; i++) {
                    ...
                    chil.emit(evenMap_235.TouchCancel);
                }
                this.step++;
